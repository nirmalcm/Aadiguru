package com.webcreo.nirmal.aadiguru.utils;
...
public class ViewAnimation {
    ...
    public static void startFadeInOut(final View v) {
        v.setAlpha(0.0f);
        AlphaAnimation fadeIn = new AlphaAnimation(0.0f,0.1f);
    ...
    public static void endFadeInOut(final View v) {
        v.clearAnimation();
    }

    public static void fadeInOut(final View v, final AnimListener animListener) {
        v.setVisibility(View.GONE);
        v.setAlpha(0.0f);
        // Prepare the View for the animation
        v.animate()
